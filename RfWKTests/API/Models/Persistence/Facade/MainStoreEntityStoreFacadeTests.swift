//
//  MainStoreEntityStoreFacadeTests.swift
//  RfWKTests
//
...
class MainStoreEntityStoreFacadeTests: EntityStoreFacadeTests {

    override func buildStack() -> Stack {
        return Stack(fileName: Constants.sqliteTestFileName)
    }
    
    // MARK: - function RemoveSequentially()
    ...
    func testRemoveAllSequentially() {
        ...
        XCTContext.runActivity(named: "Make sure there are expected amounts of each entity type") { _ in
